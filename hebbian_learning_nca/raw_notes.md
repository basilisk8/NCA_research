 - NCA are local
 - brain is local
 - brain uses hebbian learning (and maybe smt more) to learn
 - can NCA's be trained to memorize something just purely hebbian learning, no backprop or chain rule to modify weights with calc
